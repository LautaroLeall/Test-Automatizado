...
WebUI.setText(findTestObject('Page_Fleeswap/input_'), GlobalVariable.G_UserPassword)

WebUI.click(findTestObject('Page_Fleeswap/button_Inici sesin'))

WebUI.click(findTestObject('Page_Fleeswap/button_Lautaro'))

WebUI.click(findTestObject('Page_Fleeswap/a_Ver perfil'))
